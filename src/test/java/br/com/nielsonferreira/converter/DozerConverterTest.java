package br.com.nielsonferreira.converter;

import br.com.nielsonferreira.converter.mocks.MockPerson;
...
public class DozerConverterTest {
    ...
    public void parseEntityToVOTest() {
        br.com.nielsonferreira.data.vo.PersonVO output = DozerConverter.parseObject(inputObject.mockEntity(), br.com.nielsonferreira.data.vo.PersonVO.class);
    ...
    public void parseEntityListToVOListTest() {
        List<br.com.nielsonferreira.data.vo.PersonVO> outputList = DozerConverter.parseListObjects(inputObject.mockEntityList(), br.com.nielsonferreira.data.vo.PersonVO.class);
        br.com.nielsonferreira.data.vo.PersonVO outputZero = outputList.get(0);
        ...
        br.com.nielsonferreira.data.vo.PersonVO outputSeven = outputList.get(7);
        ...
        br.com.nielsonferreira.data.vo.PersonVO outputTwelve = outputList.get(12);
